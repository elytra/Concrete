...
dependencies {
	deobfCompile 'com.elytradev:concrete:0.3.1:common'
	shadow 'com.elytradev:concrete:0.3.1:common'

	deobfCompile 'com.elytradev:concrete:0.3.1:<module name>'
	shadow 'com.elytradev:concrete:0.3.1:<module name>'
}
```
