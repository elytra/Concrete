...
public final class Presets {
     ...
     */
    public static Consumer<ConcreteBlock.Builder> ORE_PRESET = builder -> builder.drop(ItemDropBehaviour.Fortune.DEFAULT);
     ...
     * @see ConcreteBlock.Builder#preset(Consumer)
     */
    public static Consumer<ConcreteBlock.Builder> GLASS_PRESET = builder -> builder.material(Material.GLASS)
